...
#define	QL_FLASH_MEM_HEADER1_ADDR       FLASH_MEM_HEADER1_ADDR
#define	QL_FLASH_MEM_HEADER2_ADDR       FLASH_MEM_HEADER2_ADDR
#define	QL_BOOTLOADER_FLASH_LOAD_ADDR   BOOTLOADER_FLASH_LOAD_ADDR
#define	QL_FLASH_MEM_RESERVED           BOOTLOADER_FLASH_LOAD_ADDR+BOOTLOADER_FLASH_LOAD_SIZE
#define	QL_FLASH_FOTA_REGION_START      FLASH_FOTA_REGION_START
#define	QL_NVRAM_FACTORY_PHYSICAL_BASE  NVRAM_FACTORY_PHYSICAL_BASE
#define	QL_NVRAM_PHYSICAL_BASE          NVRAM_PHYSICAL_BASE
#define	QL_AP_FLASH_LOAD_ADDR           AP_FLASH_LOAD_ADDR
#define	QL_FLASH_FS_REGION_START        FLASH_FS_REGION_START
#define	QL_UPDATER_FLASH_LOAD_ADDR      UPDATER_FLASH_LOAD_ADDR
#define	QL_FLASH_MEM_BACKUP_ADDR        FLASH_MEM_BACKUP_ADDR
#define	QL_FLASH_MEM_PLAT_INFO_ADDR     FLASH_MEM_PLAT_INFO_ADDR
*/
/*========================================================================
